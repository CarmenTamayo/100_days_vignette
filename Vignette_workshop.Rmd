...
knitr::include_graphics('scenario1sm.png')
```
<br>
...
* Epi curve and maps
  ...
  + Used [`incidence`](https://www.repidemicsconsortium.org/incidence/) and [`incidence2`](https://www.reconverse.org/incidence2/dev/index.html) for incidence calculation and visualisation
...
* Epidemic projections
  ...
  + [`incidence`](https://www.repidemicsconsortium.org/incidence/reference/fit.html) R estimation using a loglinear model
  + [`projections`](https://www.repidemicsconsortium.org/projections/) using Rt estimates, SI distributions and overdispersion estimates
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('scenario2sm.png')
```
<br>
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('scenario3sm.png')
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('scenario4sm.png')
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('scenario5sm.png')
```
