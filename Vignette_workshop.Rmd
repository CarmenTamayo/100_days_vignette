...
| Data cleaning         | Large amount of code lines used on (reasonably) predictable cleaning (e.g. data sense checks) <br> Omitting too many data entries when simply removing *NA* rows <br> Non standardised data formats <br> Implementing rapid quality check reports before analysis |
...
## What does the ideal outbreak analytics ecosystem look like?

The discussion of the pertinence and constraints on several approaches and tools presented by the groups established a, yet open, debate on the ideal outbreak analytics ecosystem. This collection of data sources, analytic methods, software, and communication strategies should be robust enough to provide confidence on its results; while being dynamic to the changing challenges on data access, climate, medical infrastructure, cultural differences, and/or biological threats involved in an outbreak. In addition, the workshop assistants highlighted the importance of:

-   Transparency in the methods

-   Cross-validation of the results

-   Clear statement of assumptions and parameters

-   Communication and accountability of findings, including the communication of uncertainty, scenarios, and next steps for decision makers

- Interdisciplinary pipelines and research collaboration

Initiatives like the Epiverse provide outstanding opportunities in the improvement of epidemiological consensus, revision on methodologies, analytics pipelines, responsibilities, and collaborations in the hasten context of an outbreak  
