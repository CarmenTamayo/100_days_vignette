...
This vignette summarises the activity conducted by the participants of the 100 days and 100 lines of code workshop, organised by Epiverse-TRACE. 

The aim of this activity was for participants to explore current challenges and potential solutions in the data analysis process during an outbreak investigation. To do so, participants (n=40) were divided into groups (n=5). Each group was asked to develop an epidemic scenario, by modifying a simulated linelist and contact database, creating a situation report, and a list of aims to guide a response intervention. Groups then exchanged epidemic scenarios and analysed the provided data as if they were an outbreak response team. 

Details about each of these outbreak scenarios and the analytic pipelines developed by the groups are summarised below.
