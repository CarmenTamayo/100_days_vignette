...
knitr::include_graphics('Scenario1smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('Scenario2smq.png')
```
<br>
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('Scenario3smq.png')
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('Scenario4smq.png')
```
...
```{r, echo=FALSE, out.width="70%"}
knitr::include_graphics('Scenario5smq.png')
```
