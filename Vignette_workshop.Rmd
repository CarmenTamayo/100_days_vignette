...
I somehow feel a few sentences / bullet points could be helpful here to draw common threads across the three scenarios. Also a few words on what active development is ongoing / happenings taking place (i.e. the showcase that you hosted the other week, the work on the packages and what are the links to the repos) could be helpful and stimulate extra awareness on how these workshop findings directed straight into informing some follow-up activities/prioritization. But maybe this will come in the longer perspective piece, so if so, disgregard!
